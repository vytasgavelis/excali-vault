// document.getElementById("save-diagram").addEventListener('click', (event) => {
//     saveCurrentDiagram();
// })

// document.getElementById("reload-diagrams").addEventListener('click', (event) => {
//     reloadDiagramsList();
// })
...
//     let currentListDecoded = JSON.parse(currentList);
//     console.log(currentListDecoded);
// }

// function reloadDiagramsList() {
